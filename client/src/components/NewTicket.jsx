...
//                         <input className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="title" id="title" onChange={handleChange} value={newTicketData.title} required/>
//                     </div>

//                     <div className="flex flex-col">
//                         <label className="mb-2 font-semibold text-gray-700" htmlFor="summary">Summary:</label>
//                         <input className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="summary" id="summary" onChange={handleChange} value={newTicketData.summary}  />
//                     </div>

//                     <div className="flex flex-col">
//                         <label className="mb-2 font-semibold text-gray-700" htmlFor="recipe">Status:</label>
//                         <input className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" name="status" id="status" cols="30" rows="10" onChange={handleChange} value={newTicketData.status}/>
//                     </div>

//                     <div className="flex flex-col">
//                         <label className="mb-2 font-semibold text-gray-700" htmlFor="priority">Priority:</label>
//                         <input className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="priority" id="priority" onChange={handleChange} value={newTicketData.priority} />
//                     </div>
